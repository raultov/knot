...
### Previous Release (v1.3.2 — Entity Subgraph Traversal) ✅
...
### Previous Release (v1.3.0 — Consolidated `.knot/` Directory) ✅
...
### Previous Release (v1.2.7 — Cargo Cross-Repo Dependency Fixes) ✅
